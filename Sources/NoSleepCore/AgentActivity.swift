...
public final class AgentActivityTracker {
    ...
    /// Records one polling tick. Returns true when any watched process burned
    /// at least `busyCPUSeconds` of CPU since the previous tick. A process
    ...
    public func recordTick(samples: [ProcessSample]) -> Bool {
